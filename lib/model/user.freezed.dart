...
/// @nodoc
abstract class _$$_UserCopyWith<$Res> implements $UserTokenCopyWith<$Res> {
...
/// @nodoc
class __$$_UserCopyWithImpl<$Res> extends _$UserTokenCopyWithImpl<$Res, _$_User>
...
class _$_User implements _User {
  const _$_User({required this.refresh, required this.access});
  ...
  @override
  String toString() {
    return 'UserToken(refresh: $refresh, access: $access)';
  }
...
abstract class _User implements UserToken {
  const factory _User(
      {required final String refresh, required final String access}) = _$_User;
